...
const steps = ['Deny Loan'];

export default function DenyLoanStepper(props) {
  ...
  const submit = async () => {
    ...
    try {
      ...
      await bankContract.methods.denyLoan(props.loanApplication.id)

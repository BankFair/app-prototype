...
const steps = ['Cancel Loan'];

export default function CancelLoanStepper(props) {
  ...
  const submit = async () => {
    ...
    try {
      ...
      await bankContract.methods.cancelLoan(props.loanApplication.id)

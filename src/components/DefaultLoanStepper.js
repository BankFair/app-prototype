...
const steps = ['Default Loan'];

export default function DefaultLoanStepper(props) {
  ...
  const submit = async () => {
    ...
    try {
      ...
      await bankContract.methods.defaultLoan(props.loanApplication.id)
                ...
                : isNextLoading
                  ...
                  : txReceipt && <>
                    <Typography sx={{ mt: 2, mb: 1, alignSelf: 'center' }} >
                      Default Loan Request Submitted
                    </Typography>
        ...
        <>
                  ...
                  <>
                    ...
                    <Grid>
                      <Grid container spacing={0} sx={{ ml: 2, }}>
                        ...
                        {props.loanDetail.lastPaymentTime && <GridRow label="Last payment time" value={props.loanDetail.lastPaymentTime} lcWidth="6" rcWidth="6" />}
                        <GridRow label="Total amount repaid" value={props.loanDetail.totalAmountPaid + " " + props.data.tokenSymbol} lcWidth="6" rcWidth="6" />
                        <GridRow label="Base amount repaid" value={props.loanDetail.baseAmountRepaid + " " + props.data.tokenSymbol} lcWidth="6" rcWidth="6" />
                        <GridRow label="Interest paid" value={props.loanDetail.interestPaid + " " + props.data.tokenSymbol} lcWidth="6" rcWidth="6" />
                      </Grid>
                    </Grid>
                  </>
              }[activeStep]
          ...
          <Box sx={{ display: 'flex', flexDirection: 'row', pt: 2, mb: '0' }}>
            ...
            <Button onClick={handleNext}
              disabled={isNextLoading || (activeStep === 0 && props.loanApplication.status !== 'FUNDS WITHDRAWN')}>
